...
let large = frase.length;    //Devuelve la longitud del string.
let array=[]
let contador=0
for (i = 0; i < large; i++) {
     let vocal = frase.toLowerCase().charAt(i);    //recupera el caracter i del string.
...
console.log(`La cantida de vocales encontradas es iguala a: ${contador}`)
